package cn.ybz21.hibotvoice.widget;
...
public class RecordButton extends Button {
    ...
    private void startRecording() {
        mRecorder = new MediaRecorder();//new出MediaRecorder()对象
        mRecorder.setAudioSource(MediaRecorder.AudioSource.MIC);//设置MediaRcorder的音频源为麦克风
        mRecorder.setOutputFormat(MediaRecorder.OutputFormat.RAW_AMR);//设置MediaRecorder录制的音频格式
        mRecorder.setAudioEncoder(MediaRecorder.AudioEncoder.AMR_NB);//设置理智音频的编码编码为amr
